...
;   
;   
(define (problem MazeRooms-3by3-ThreeDisposableKeysBalls)
        ...
        (:objects
            ...
            D-blue-1-2-2-2 D-yellow-0-1-1-1 D-yellow-1-1-1-2 D-yellow-0-0-0-1 D-green-1-1-2-1 D-green-0-2-1-2 D-yellow-0-0-1-0 D-yellow-1-0-2-0 D-green-2-0-2-1 D-yellow-1-0-1-1 - door
        )
        (:init
