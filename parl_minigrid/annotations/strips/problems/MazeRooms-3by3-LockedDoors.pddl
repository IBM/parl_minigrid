...
(define (problem MazeRooms-3by3-LockedDoors)
        ...
        (:objects
            ...
            K-yellow-0 - key
            D-yellow-0-1-0-2 D-yellow-1-1-2-1 D-yellow-2-0-2-1 D-yellow-2-1-2-2 D-yellow-0-2-1-2 D-yellow-1-0-2-0 D-yellow-1-1-1-2 D-yellow-0-0-1-0 D-yellow-0-0-0-1 D-yellow-1-0-1-1 D-yellow-0-1-1-1 D-yellow-1-2-2-2 - door
        )
        (:init
