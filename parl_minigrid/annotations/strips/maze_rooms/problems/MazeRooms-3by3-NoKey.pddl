...
;   
;   
(define (problem MazeRooms-3by3-NoKey)
        (:domain MazeRooms)
        (:objects
            R-0-0 R-0-1 R-0-2 R-1-0 R-1-1 R-1-2 R-2-0 R-2-1 R-2-2 -  room
            D-yellow-1-0-1-1 D-yellow-2-0-2-1 D-yellow-0-0-1-0 D-yellow-1-1-1-2 D-yellow-0-0-0-1 D-yellow-1-1-2-1 D-yellow-0-1-1-1 D-yellow-0-2-1-2 D-yellow-1-0-2-0 D-yellow-1-2-2-2 - door
        )
        (:init
